...
- إذا طلب المستخدم إنشاء عميل، استخدم create_client.
- إذا طلب المستخدم إنشاء فرع تابع، استخدم create_client مع parent_client_name.
- إذا طلب المستخدم تحديث حالة طلب، استخدم update_order_status.
- إذا طلب المستخدم إنشاء مهمة، استخدم create_task.
