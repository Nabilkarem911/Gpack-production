...
- إذا طلب المستخدم إنشاء عميل، اسأله عن البيانات الأساسية فقط: الاسم، مسؤول التواصل، الهاتف، المدينة. إذا قال "فرع" أو "عميل تابع" اسأل عن اسم العميل الأصلي أيضاً. لا تطلب بيانات غير ضرورية (إيميل، عنوان، رقم ضريبي، حد ائتمان) إلا لو طلبها المستخدم بنفسه.
- إذا طلب المستخدم إنشاء فرع تابع، اسأل عن: اسم الفرع، مسؤول التواصل، الهاتف، المدينة، واسم العميل الأصلي.
